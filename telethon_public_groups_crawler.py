...
# loop.run_until_complete(get_info_when_a_user_was_last_seen())
...
def log(group_name=args.tgpgn):
    ...
    if group_name is not None:
        FORMAT = '%(message)s'
        logging.basicConfig(
            filename=f'{THIS_SCRIPT_DIR}/{group_name}.log', 
            level=logging.INFO,
            format=FORMAT
        )
